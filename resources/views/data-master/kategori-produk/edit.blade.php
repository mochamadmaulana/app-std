@extends('layout.app', ['title' => 'Edit Kategori Produk'])
...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm">
                    <h1 class="m-0"><i class="fas fa-server"></i> Edit Kategori Produk</h1>
                </div>
                <div class="col-sm-6">
...
@section('content')
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('data-master.kategori-produk.update', $kategori_produk->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" value="{{ $kategori_produk->nama }}" class="form-control @error('nama') is-invalid @enderror" autofocus>
                            @error('nama')
